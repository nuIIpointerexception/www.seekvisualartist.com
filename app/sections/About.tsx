  ...
  return (
    ...
    >
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        <AnimatedTitle
          text={
            "CREATING STUNNING VISUALS SINCE 2013."
          }
          className={
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          ...
          <AnimatedBody
            text="My passion lies in creating software that is both beautiful and functional. I’ve been designing for over 8 years and recently started getting into programming."
          />
